...
3. Click "Download All Files" to download all files from the course - (Sometimes a download button isn't available on Toledo and/or will block downloads for certain documents. The extension can nonetheless download the documents for you despite restrictions.)
